  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="relative w-full h-80 bg-slate-200">
        <Image
          src="https://images.unsplash.com/photo-1515876305430-f06edab8282a?w=1200&h=400&fit=crop"
          alt="Camping van"
          fill
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="bg-white p-8 rounded-lg border border-slate-200">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">Zusammenfassung</h2>
